...
class QuantitySettingsForm extends ConfigFormbase {
  ...
  public function buildForm(array $form, FormStateinterface $form_state) {
    ...
    $form['system_of_measurement'] = [
      ...
      '#description' => $this->t('Select the system of measurement you would like to use in shambaOS. Changing this setting after data has been entered is not recommended.'),
      '#options' => [
