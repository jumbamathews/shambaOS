...
/**
 * Form for installing shambaOS modules.
 *
 * @ingroup farm
 */
class FarmSettingsModulesForm extends FormBase {
  ...
  /**
   * The package name for shambaOS contrib modules.
   *
   * @var string
   */
  const FARM_CONTRIB_PACKAGE = 'shambaOS Contrib';

  /**
   * The package name for shambaOS quick form modules.
   *
   * @var string
   */
  const FARM_QUICK_PACKAGE = 'shambaOS Quick Forms';
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $batch = [
      ...
      'title' => $this->t('Installing shambaOS modules'),
   ...
   *
   * Performs batch installation of shambaOS modules.
   */
