...
class FarmEntityFieldTest extends KernelTestBase {
  ...
  /**
   * Test shambaOS fields defined in hook_entity_base_field_info().
   */
  ...
  /**
   * Test shambaOS fields defined in hook_farm_entity_bundle_field_info().
   */
  ...
  /**
   * Test shambaOS fields defined in buildFieldDefinitions().
   */
  ...
  /**
   * Test that shambaOS base fields can be overridden.
   */
