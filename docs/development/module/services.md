...
shambaOS provides some [services](https://symfony.com/doc/current/service_container.html)
...
shambaOS. This is used by modules that add [fields](/development/module/fields)
...
class, with shambaOS-specific opinions to help enforce some consistency among
shambaOS core and contrib modules. You can create instances of these field
definition classes directly instead of using the shambaOS field factory service.
...
[FarmFieldFactory](https://github.com/shambaOS/shambaOS/blob/2.x/modules/core/field/src/FarmFieldFactory.php)
