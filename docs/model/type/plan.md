...
*shambaOS core does not currently provide any Plan types.*
...
Archived Plans will be hidden from most lists in shambaOS unless they are
explicitly requested.

#### Flags

Flags can be added to Plans to help with sorting and filtering. shambaOS
...
be displayed alongside the Plan in shambaOS. If the photos pertain to specific
