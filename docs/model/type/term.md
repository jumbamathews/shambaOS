...
organize and manage Terms used in various contexts throughout shambaOS. These can
be used for flagging, categorization, and organization of other record types.

Most Terms in shambaOS are user-defined, and the vocabularies are empty when
shambaOS is first installed. As [Logs](/model/type/log) and
...
is enabled. The modules included with shambaOS define the following vocabularies:
