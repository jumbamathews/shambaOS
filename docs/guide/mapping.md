...
shambaOS gives you the ability to organize all the various places on (and off)
your farm. These places are represented as [Assets](/guide/assets) in shambaOS,
...
To create a location Asset, go to the shambaOS Dashboard and click the "Add
...
shambaOS can import geometries from KML, KMZ, GPX, and GeoJSON files. If you
already have your farm mapped in another software (like Google Earth), you
can export KML files for each area and then import them into shambaOS records.
...
shambaOS includes a "snapping grid" tool to aid in creating regular/aligned
...
![shambaOS Snapping Grid dimensions screenshot](/img/snapping_grid_dimension_explanation.png)
