...
/**
 * @file
 * General functions for the shambaOS installation profile.
 */

/**
 * Define shambaOS modules that can be installed.
 *
 * @return array
 ...
 *   optional modules will appear as options during shambaOS installation and in
 *   a form available to admins. During initial shambaOS installation, default
...
function farm_modules() {
  return [
    'base' => [
      'farm_api' => t('shambaOS API'),
      'farm_login' => t('Login with username or email.'),
      'farm_settings' => t('shambaOS Settings forms'),
      'farm_ui' => t('shambaOS UI'),
      'farm_update' => t('shambaOS Update'),
    ],
    'default' => [
...
function farm_form_update_manager_update_form_alter(&$form, &$form_state, $form_id) {
  ...
  $message = t('Performing updates through this interface is disabled by shambaOS. To update modules, use a packaged release of shambaOS to ensure that any necessary patches are applied to dependencies.');
